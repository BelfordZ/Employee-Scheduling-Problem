...
function ZB() {
   ...
   //holds a Date object with representing tomorrow at 8am
   this.START_DAY = Date.future('8am');
   //holds a Date object representing num_days_to_schedule days ahead of tomorrow at 8am
   this.END_DAY = Date.create(this.START_DAY).addDays(this.NUM_DAYS_TO_SCHEDULE);
   //hold Date.range obj
   this.DATE_RANGE = Date.range(this.START_DAY, this.END_DAY);
   this.SHIFT_RANGE = this.DATE_RANGE.every((12).hours());
}
